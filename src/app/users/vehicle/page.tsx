...
export default function VehiclePage() {
  ...
  return (
    // Layout principal en colonne pour le responsive
    <div className="flex min-h-screen h-screen bg-gray-100 flex-col">
      <div className="flex flex-1">
        ...
        >
          ...
          <Divider />
          {/* Menu centralisé réutilisable (icônes + labels) */}
          <Box sx={{ p: 2 }}>
            {menuItems.map((item) => (
              <a
                key={item.title}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="sticky top-0 z-20">
            ...
            <div className="flex items-center px-2 py-2 bg-white border-b border-gray-200 md:hidden">
              ...
              <span className="ml-2 font-bold text-lg">Véhicules</span>
            </div>
            <Navbar />
          </div>
